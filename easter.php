...
function php_easter_days($year = NULL, $method = CAL_EASTER_DEFAULT)
{
    ...
    $golden = ($year % 19) + 1;
    /* the Golden number */
    if (($year <= 1582 && $method != CAL_EASTER_ALWAYS_GREGORIAN) || ($year >= 1583 && $year <= 1752 && $method != CAL_EASTER_ROMAN && $method != CAL_EASTER_ALWAYS_GREGORIAN) || $method == CAL_EASTER_ALWAYS_JULIAN) {
        /* JULIAN CALENDAR */
